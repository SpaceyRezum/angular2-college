export const CERTIFICATES: any[] = [
	{
		...
		url: "other-certificates",
		imgUrl: "/assets/images/certificates/other-certificates.jpg",
		overview: "",
		certificates: [
			{
				...
				duration: 0,
				certification: true,
				description: "This program has been designed for those they are in construction and architectural areas and would like to increase their knowledge and skills in home inspection that covers:",
				courses: [
					"roofing",
					"air conditioning",
					"interior and",
				...
				duration: 0,
				certification: true,
				description: "This program will give a strong hands on for those they would like to improve their skills in building websites using:",
				courses: [
					"HTML",
					"Javascript",
					"CSS"
				...
				name: "Customs Broker Training services",
				url: "customs-broker-training-services",
				duration: 0,
				certification: true,
				description: "Learners will be exposed to:",
				courses: [
					"Custom Canadian Act",
					"Canadian Boarder Services duties",
					"Canadian import-export rules",
					"Tariff classification, duties and taxes",
					"Canadian food agency act and rules for licenses et permits"
				]
			}, {
				name: "Senior project Management",
				url: "senior-project-management",
				duration: 0,
				certification: true,
				description: "This is a crash course for those they would like to go beyond PMP Exam Prep and increase their knowledge and skills in Project Management programs.",
				courses: []
			}, {
				name: "Inventory",
				url: "inventory",
				duration: 0,
				certification: true,
				description: "The student will learn the theories and importance of inventory management in retail settings. Students will identify the steps in receiving, verifying and reconciling orders and updating inventory etc.",
				courses: []
			}, {
				name: "Fraud Investigation and Forensic Accounting Training",
				url: "fraud-investigation-and-forensic-accounting-training",
				duration: 0,
				certification: true,
				description: "Learners will learn professional skills and practical techniques to detect and prevent fraud in today's business world. They also learn how to investigate and analyze financial evidence and understand the theories of ethics and criminology.",
				courses: []
			}, {
				name: "Home Inspection II",
				url: "fraud-investigation-and-forensic-accounting-training",
				duration: 0,
				certification: true,
				description: "This program has been designed for those they are in deep research of all details in construction and architectural areas and would like to increase their knowledge and skills in home inspection that covers: roofing, air conditioning, interior and electrical part…",
				courses: []
			}, {
				name: "Pre-apprenticeship Training for Construction and Maintenance Electrician",
				url: "pre-apprenticeship-training-for-construction-and-maintenance-electrician",
				duration: 0,
				certification: true,
				description: "This program is designed to give students a combined of theoretical and hands-on practical experience to make them successful apprentices. Participants will learn how to design, install, and maintain electrical systems. Therefore they practice in their field through unpaid practicum program, where they will have many duties such as planning projects, installing new or upgrading old systems, wiring, receptacles, lighting fixtures, Safety Training, Basic Electrical Theory, introduction to Canadian Electrical Safety Code, Introduction to Residential Prints and practicum. Our participants will obtain the skills, training, and experience needed to make them the most sought after electrical apprentices in their field.",
				courses: []
			}, {
				name: "Pre-internship Program for Plumbing",
				url: "pre-internship-program-for-plumbing",
				duration: 0,
				certification: true,
				description: "The Pre-Apprenticeship training will receive theory instruction, together with the hands-on training methodology in the following fields:",
				courses: [
					"Fundamental Estimations",
					"OHS",
					"Auto-Cad",
					"CSR",
					"Sub Construction Forms and Practicum"
				]
			}
		]
	}
